...
;(function($, window, document, undefined)
{
	...
	$.fn.styleSelect = function(options)
	{
		...
		return this.each(function(i)
		{
			...
			{
				// Create
				select = $('<span class="'+this.className.replace(/(\s*)select(\s*)/, '$1selectMultiple$2')+disabled+' replacement"'+title+widthString+' tabindex="0">'+
			...
			else
			{
				...
				// Create
				select = $('<span class="'+this.className+disabled+' replacement"'+title+widthString+' tabindex="0">'+
